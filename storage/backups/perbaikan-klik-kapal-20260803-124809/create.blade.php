...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const selectJadwal = function (radio) {
        ...
        /*
         * Memicu perhitungan kapasitas tanpa menghalangi
         * fungsi asli label HTML.
         */
        radio.dispatchEvent(
            new Event('change', {
                bubbles: true,
    ...
    /*
     * Fallback klik untuk seluruh bagian card.
     * Tidak menggunakan preventDefault dan stopPropagation.
     */
    ...
    /*
     * Pastikan satu jadwal sudah dipilih ketika halaman dibuka.
     */
    const selected =
    ...
    selectJadwal(selected);
});
</script>
{{-- FIX_NATIVE_KLIK_KAPAL_END --}}
