...
{{-- FIX_KLIK_CARD_JADWAL_START --}}
<script>
(function () {
    const initializeJadwalCards = function () {
        const radios = Array.from(
            document.querySelectorAll(
                'input.jadwal-radio[name="jadwal_id"]'
            )
        );
        ...
        const selectSchedule = function (radio) {
        ...
        radios.forEach(function (radio) {
             ...
             * Hanya membuat seluruh area card dapat diklik.
             */
        ...
        /*
         * Pastikan selalu ada satu jadwal terpilih.
         * Jadwal dari request/old diprioritaskan.
         */
        const selectedRadio =
            document.querySelector(
                'input.jadwal-radio[name="jadwal_id"]:checked'
            )
            || radios[0];

        selectSchedule(selectedRadio);
    };

    if (document.readyState === 'loading') {
        document.addEventListener(
            'DOMContentLoaded',
            initializeJadwalCards,
            {
                once: true,
            }
        );
