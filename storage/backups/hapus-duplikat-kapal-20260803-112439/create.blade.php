...
{{-- KATALOG_KAPAL_CREATE_START --}}
@include(
    'user.pemesanan.partials.katalog-kapal-create',
    [
        'kapals' => $kapals ?? collect(),
        'jadwalsByKapal' => $jadwalsByKapal ?? collect(),
    ]
)
{{-- KATALOG_KAPAL_CREATE_END --}}
